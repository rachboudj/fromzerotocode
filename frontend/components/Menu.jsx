                    ...
                    <div className='relative'>
                        ...
                        <div
                            ...
                            <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                                ...
                                <hr />
                                <a href="/instructor-admin" className="block px-4 py-2 text-sm text-red-500  hover:bg-gray-100 hover:text-red-700" role="menuitem" onClick={handleLogout}>Se déconnecter</a>
                            </div>
                        </div>
                    </div>
                </div>
