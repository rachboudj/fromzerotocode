                ...
                <div className='mt-8 max-w-md mx-auto'>
                    ...
                    {category && (
                        <div>
                            ...
                            <button className='mt-5 text-white bg-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800' onClick={handleSubmit}>Enregistrer les modifications</button>
                        </div>
                    )}
                </div>
            </AdminRoute>
